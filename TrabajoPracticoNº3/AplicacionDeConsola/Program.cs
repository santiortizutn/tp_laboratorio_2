...
namespace AplicacionDeConsola
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            EntidadesAbstractas_.Persona.ENacionalidad.Argentino, Gimnasio.EClases.CrossFit,
            Alumno.EEstadoCuenta.MesPrueba);
            gim += a1;
            try
            {
                Alumno a2 = new Alumno(2, "Juana", "Martinez", "12234458",
                EntidadesAbstractas_.Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion,
            ...
            EntidadesAbstractas_.Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Pilates,
            ...
            EntidadesAbstractas_.Persona.ENacionalidad.Argentino, Gimnasio.EClases.Natacion,
            Alumno.EEstadoCuenta.Deudor);
            gim += a6;
            ...
            EntidadesAbstractas_.Persona.ENacionalidad.Argentino, Gimnasio.EClases.Pilates,
            Alumno.EEstadoCuenta.AlDia);
            gim += a8;
            Instructor i1 = new Instructor(1, "Juan", "Lopez", "12234456",
            EntidadesAbstractas_.Persona.ENacionalidad.Argentino);
            gim += i1;
